...
public class E2e {
    ...
    public void fillingInformationFormTest() {
        new CartPage(driver).clickOnCheckoutButton()
                .fillingInformationForm(FILE_NAME,LAST_NAME, testData.getJsonData("information-form.postal-code"))
                .assertInformationPage(FILE_NAME, LAST_NAME, testData.getJsonData("information-form.postal-code"));
    }
    ...
    public void beforeClass() {
        ...
        FILE_NAME = testData.getJsonData("information-form.first-name") + getTimeStamp();
